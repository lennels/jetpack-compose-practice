...
@Composable
fun ItemList(makanList: List<MakanItem>, modifier: Modifier) {
    LazyColumn(
        modifier = modifier
            .padding(12.dp)
    ) {
        items(items = makanList) { makan ->
            ...
            ItemCard(id, name, price, quantity, modifier = Modifier.padding(vertical = 8.dp))
...
@Composable
fun ItemCard(id: Int, name: String, price: Double, quantity: Int, modifier: Modifier = Modifier) {
...
@Composable
fun BottomSummary(modifier: Modifier = Modifier) {
    Box() {
        Column() {
            Row() {
                Text("Subtotal:")
